...
for ii=1:length(n);
    ...
    grid on;
    xlabel('{\theta}','FontSize',8,'FontName','Times');
    ylabel('cos(n{\theta})','FontSize',8,'FontName','Times');
end
...
%% Chebyshev Polynomials and their nodes
...
for ii=1:LL;
    ...
    grid on;
    xlabel('{\theta}','FontSize',8,'FontName','Times');
    ylabel('cos({(2n-1)} /{\theta})','FontSize',8,'FontName','Times');
end
%}
