...
ylabel('Function values','FontSize',16,'FontName','Times');
title('Function value of Lagrange approximation with uniform nodes','FontSize',16,'FontName','Times');
...
xlabel('Interval values','FontSize',16,'FontName','Times');
ylabel('Function values','FontSize',16,'FontName','Times');
title('Function value of Lagrange approximation with Chebyshev nodes','FontSize',16,'FontName','Times');
legend('f(x) = (1+x^2)^{-1}','Tenth degree Lagrange interpolation')
%axis( [min(x)-0.2, max(x)+0.2, ceil(min(L))-1.5, floor(max(L))+1.5] );
%plot( x, ones( size(x) ), '.b', 'MarkerSize', 18 );
%plot( x, zeros( size(x) ), 'sr' );
...
hold on;
plot(xx,error_uniform_nodes);
xlabel('Interval values','FontSize',16,'FontName','Times');
ylabel('Error Values','FontSize',16,'FontName','Times');
title('Errors of the Lagrange approximation','FontSize',16,'FontName','Times');
